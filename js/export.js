...
// Premium export — Word (requires premium)
function exportWord() {
...
function trackFirstExport() {
  ...
  if (!already) {
    ...
    setTimeout(() => {
      if (typeof showToast === 'function') showToast('🎉 Your resume is out in the world! Good luck 🤞');
    }, 1200);
  }
}
...
function showFeedbackPopup() {
  ...
  popup.innerHTML = `
    ...
    <div style="font-family:'Syne',sans-serif;font-weight:800;font-size:0.95rem;color:#c9a84c;margin-bottom:0.4rem;">✨ Looking good!</div>
    <div style="font-size:0.82rem;color:#888;margin-bottom:1rem;line-height:1.5;">How was your experience with Prime Resume? Your feedback helps us improve.</div>
    ...
    <button onclick="submitFeedbackPopup()" style="width:100%;background:#c9a84c;color:#000;border:none;padding:0.65rem;font-family:'Syne',sans-serif;font-weight:700;font-size:0.78rem;letter-spacing:0.08em;text-transform:uppercase;cursor:pointer;">Submit Feedback</button>
  `;
