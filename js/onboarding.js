  ...
  if (!document.getElementById('obCSS')) {
    ...
    s.textContent = [
      ...
      '.ob-box{position:fixed;z-index:9003;background:#0d0d0d;border:2px solid #c9a84c;',
        'padding:1.8rem 2rem;max-width:340px;min-width:280px;',
        'box-shadow:0 12px 50px rgba(0,0,0,0.9);pointer-events:all;}',
      '.ob-box h3{font-family:Syne,sans-serif;font-weight:800;font-size:1.1rem;',
        'color:#c9a84c;margin:0 0 0.7rem;}',
      '.ob-box p{font-family:"DM Sans",sans-serif;font-size:0.95rem;color:#ccc;',
